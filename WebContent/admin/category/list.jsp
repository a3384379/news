						...
						<c:forEach items="${requestScope.categoryList }" var="cate"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="18%">${var.count }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="17%">${cate.cname }</td>
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/toedit.action?cid=${cate.cid}">
										<img
...
<script type="text/javascript">
		...
		function addCategory(){
 		...
 		function del(id) {
			...
			if(flag) {
				location.href="${pageContext.request.contextPath}/deleteCategory.action?cid="+id;
			}
			}
