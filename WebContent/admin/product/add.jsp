...
<body>
	...
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/addNews.action"
		method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>添加新闻</STRONG> </strong></td>
			</tr>

			<tr>
				<td width="8%" align="center" bgColor="#f5fafe" class="ta_01">
					新闻标题：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text" style="width: 100%"
					name="title" value="" id="userAction_save_do_logonName" class="bg" />
				</td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3">
					<div id="div1">
						<textarea id="text1" style="width: 100%; height: 200px;display: none;"
							 name="test"></textarea>
					</div>
				</td>
			</tr>
